    ...
    <div class="ca-field ca-field-locked">
      <div class="ca-field-header">
        ...
        <label class="ca-label">
          ...
          <button type="button" class="ca-help" data-tooltip="{'bg_clear_global_tp'|@translate}">ⓘ</button>
        </label>
      </div>
    ...
    <div class="ca-field ca-field-locked">
      <div class="ca-field-header">
        ...
        <label class="ca-label">
          ...
          <button type="button" class="ca-help" data-tooltip="{'bg_clear_content2_tp'|@translate}">ⓘ</button>
        </label>
      </div>
      <div class="ca-field-controls ca-field-controls-color">
        <div class="ca-color-picker-wrapper">
    ...
    <div class="ca-field ca-field-locked">
      <div class="ca-field-header">
        ...
        <label class="ca-label">
          ...
          <button type="button" class="ca-help" data-tooltip="{'bg_clear_content1_tp'|@translate}">ⓘ</button>
        </label>
      </div>
      <div class="ca-field-controls ca-field-controls-color">
        <div class="ca-color-picker-wrapper">
    ...
    <div class="ca-field ca-field-locked">
      <div class="ca-field-header">
        ...
        <label class="ca-label">
          ...
          <button type="button" class="ca-help" data-tooltip="{'bg_clear_content3_tp'|@translate}">ⓘ</button>
        </label>
      </div>
      <div class="ca-field-controls ca-field-controls-color">
        <div class="ca-color-picker-wrapper">
